...
@export var circle_radius: float = 240.0
...
func moving_across_circle(delta: float) -> void:
	...
	velocity += tangent_dir * step_tan_delta
...
func is_moving() -> bool:
	return player_state_machine.curr_state is MovePlayerState or player_state_machine.curr_state is SpeedUpPlayerState
